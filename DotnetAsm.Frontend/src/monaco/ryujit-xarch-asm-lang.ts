...
// Note, that it is not valid x86 assembly, it may contain pseudoinstructions like gword
monaco.languages.setMonarchTokensProvider(languageName, {
    ...
    tokenizer: {
        root: [
            ...
            [
                /\b(?:CS|DS|ES|FS|GS|SS|RAX|EAX|RBX|EBX|RCX|ECX|RDX|EDX|RCX|RIP|EIP|IP|RBP|RSP|ESP|SP|RSI|ESI|SI|RDI|EDI|DI|RFLAGS|EFLAGS|FLAGS|R(?:[8-9]|1[0-5])|(?:Y|X)MM(?:[0-9]|10|11|12|13|14|15)|(?:A|B|C|D)(?:X|H|L)|CR(?:[0-4]|DR(?:[0-7]|TR6|TR7|EFER)))\b/,
                "register",
            ],
            [
